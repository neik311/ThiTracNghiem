...
public class setTime extends javax.swing.JFrame implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while(i>=0){
                String s ="";
                s = s + String.valueOf(i/60) +":"+ String.valueOf(i%60);
                i--;
                labelClock.setText(s);
                Thread.sleep(1000);
            }
            labelClock.setText("");
    ...
    private void initComponents() {
        ...
        labelClock.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
